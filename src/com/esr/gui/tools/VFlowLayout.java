...
public class VFlowLayout extends FlowLayout {
    ...
    public Dimension preferredLayoutSize(Container container) {
        ...
        java.util.List<Component> components = this.getVisibleComponents(container);
    ...
    private Dimension preferredComponentsSize(java.util.List<Component> components) {
        Dimension rs = new Dimension(0, 0);
    ...
    private Dimension minimumComponentsSize(java.util.List<Component> components) {
        Dimension rs = new Dimension(0, 0);
